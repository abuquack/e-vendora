    ...
    <div>
      <div className='mx-auto max-w-screen-lg px-4 lg:flex flex-col justify-start py-16 items-center'>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-4 ">
          <a
            id='start-free'
            className="flex items-center justify-center gap-3 w-full rounded-lg bg-main px-12 py-2 hover:gap-10 duration-300 text-sm font-medium text-white shadow hover:bg-hover focus:outline-none focus:ring-hover/15 active:bg-main sm:w-auto"
            href="#"
          >
            ابدأ مجاناً
